...
Qualifying Gap Distribution: Box plot comparing Elite vs Midfield lap time deltas
Speed Trace Comparison: Detailed speed profiles throughout a lap
Top Speed vs. Delta Analysis: Scatter plot examining speed trap data
Throttle Application Distribution: Box plot showing throttle consistency
Speed Distribution Density: Histogram comparing speed profiles by tier
Installation
Prerequisites
...
Open f1_analysis.ipynb in Jupyter Notebook or VS Code with Jupyter extension
Run all cells sequentially (Ctrl+Shift+P → "Run All Cells")
Data Collection
...
Valid Lap Time: Filters out laps with missing or zero lap times
Valid Telemetry: Ensures telemetry data exists for each lap
Clean Missing Values: Drops laps with >10% missing data points
...
Acknowledgments
FastF1 Library for providing access to F1 telemetry data
